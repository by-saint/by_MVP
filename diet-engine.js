 ...
 *
 * MUDANÇAS (Falhas 1, 2, 3, 4 Corrigidas):
 *
 * 1. (Falha 1 - Coesão) BASE DE DADOS V6 e BLUEPRINTS:
 ...
 *
 * 2. (Falha 2 - Porções) CÁLCULO DE PORÇÃO:
 ...
 *
 * 3. (Falha 3 - Contagem) LÓGICA DE REFEIÇÕES:
 ...
 *
 * 4. (Falha 4 - Variedade/Micros) ROTAÇÃO DE ALIMENTOS:
 * - A função `get` agora rotaciona entre os Top 5 alimentos
 * de uma categoria (em vez de Top 2).
 * - Os vegetais foram divididos em grupos (verdura_folha,
 * verdura_legume) e a seleção de folhas é amarrada ao
 * dia da semana para forçar rotação diária.
 * =================================================================== */
...
const SuperDietEngine = (function(){
  ...
  function extractRestrictions(profile){
    ...
    const restrictionMap = {
      ...
      'peixe': ['peixe_tilapia_grelhada','peixe_salmao_grelhado','atum_lata_agua','sardinha_lata_oleo', 'peixe_merluza_cozida', 'peixe_linguado_grelhado', 'peixe_pescada_grelhada', 'camarao_cozido'],
      'atum': ['atum_lata_agua'],
      'sardinha': ['sardinha_lata_oleo'],
      'camarao': ['camarao_cozido'],
      'frango': ['frango_peito','frango_sobrecoxa'],
      'carne vermelha': ['carne_patinho_moido','carne_alcatra_grelhada','carne_coxao_mole_cozido', 'carne_picanha_grelhada', 'carne_file_mignon_grelhado', 'carne_lagarto_cozido'],
      'carne': ['carne_patinho_moido','carne_alcatra_grelhada','carne_coxao_mole_cozido', 'carne_picanha_grelhada', 'carne_file_mignon_grelhado', 'carne_lagarto_cozido', 'porco_lombo_grelhado', 'porco_bisteca_grelhada'],
      'porco': ['porco_lombo_grelhado', 'porco_bisteca_grelhada'],
